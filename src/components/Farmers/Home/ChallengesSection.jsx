...
const ChallengesSection = () => (
  <div className="my-12">
    ...
    <p className="text-[1.6rem]">
      Freudia offers tailored mental health solutions for farmers, addressing
    ...
    <dl className="mt-4">
      <ChallengeItem title="Stress Management Programs:">
        Freudia helps farmers manage stress by providing access to stress
      ...
      <ChallengeItem title="Community Support:">
        Freudia connects farmers with peer support groups and social
      ...
      <ChallengeItem title="Crisis Intervention:">
        For farmers struggling with suicidal thoughts, Freudia provides
