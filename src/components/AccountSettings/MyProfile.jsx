...
const MyProfile = () => {
    const { decodedToken, getUserIdUserType,logout,token } = useVerification()
    const fileInputRef = useRef(null);
    const [imageSrc, setImageSrc] = useState(token?decodedToken?.profileImage||decodedToken?.photo:null); 
