...
const ExploreTherapy = () => {
  ...
  return (
    <section className="exploreSection min-h-screen bg-[#008784] p-[3rem] scrollerT relative">
      <div className="compareDiv">
        <Heading
          span="Fre"
          text="udia vs. traditional
      in-office therapy"
      ...
      <div className="relative mx-auto md:w-[97rem] lg:w-[60%] md:h-[100vh] flex flex-col items-center lg:gap-12 py-16">
        <section className=" w-[60vw] min-h-[23vh] lg:min-h`-[32vh] flex overflow-x-auto overflow-hidden scrollbar-hide">
          ...
          />
          <Reviews
            text="Shreya listens and provides excellent guidance through life's situations."
            designation="Sherya Desai (MA, LPC-S)"
            image="./../../../public/g3.jpg"
          />
          <Reviews
            ...
            designation=" Rittika (LCSW, MSW)"
            image="./../../../public/g2.jpg"
          />
          <Reviews
            text="Nancy is amazing in her insights and conversational approach. I am so glad and blessed to have found her and started healing with her guidance."
            designation=" Nancy Sharma (LPC, NCC, YACEP)"
            image="./../../../public/g1.jpg"
          />
