    ...
    <>
      <div className="min-w-[13%] h-full flex flex-col md:flex-row gap-6">
        <div className="w-full flex justify-center md:justify-start gap-6 relative ">
          ...
          >
            <div className="w-14 h-14 rounded-full bg-[#007481] flex justify-center items-center overflow-hidden">
          ...
          >
            <ul className="w-full text-[1.4rem]">
              ...
              <Link to="/user/AccountSettings/your-therapist"> <li className="py-1 hover:font-medium cursor-pointer">My Therapist</li></Link>
              <Link to="/user/AccountSettings/payment"> <li className="py-1 hover:font-medium cursor-pointer">Payment</li></Link>
              <Link to="/user/AccountSettings/notifications"> <li className="py-1 hover:font-medium cursor-pointer">Notifications</li></Link>
              <Link to="/user/AccountSettings/my-profile"> <li className="py-1 hover:font-medium cursor-pointer">Personal Information</li></Link>
...
const Header = ({ customBG }) => {
  ...
  const { userType, token, decodedToken, updateUserType, logout } = useVerification();
  ...
  useEffect(() => {
    ...
    if (userType === "farmer") {
      ...
      if (token) {
        setDoctor(decodeToken(token)?.fullName);
      }
      updateUserType(userType || null);
    } else {
      updateUserType(null);
    ...
    >
      ...
      <div className="w-full h-full hidden lg:flex">
        <div className="py-1 w-full flex justify-between items-center">
          <div className="w-[22%] flex items-center cursor-pointer"
            onClick={onHandleRedirectToHome}
          >
            <img
              src={assets.freudiaLogo}
            ...
            />
            <h2 className="text-[4rem] font-mono font-semibold tracking-tighter text-[#007481]">freudia</h2>
          </div>
          <div className="w-[78%] h-full flex justify-end pr-3 gap-7 ">
            <ul
